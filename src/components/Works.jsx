    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
          ...
          </div> Bu kısım projenin live urli varsa ve eklemek istersen*/}
        ...
        <div className='mt-5'>
          ...
          {/* Github projelerinin alakalı olduğu taglar */}
  ...
  return (
    <>
      ...
      <div className='mt-20 flex flex-wrap gap-7'>
        {/* Flex-wrap screen size küçüldüğünde wraplenmesi için kullanıyoruz */}
        {projects.map ((project, index) => (
          <ProjectCard
            key={`project-${index}`}
            index={index}
            {...project}
            //Projectin tüm propertylerini bastırıyor.
           />
        ))}
